...
const ContactFormModal = ({ isOpen, onClose, formType = 'General', source = 'Contact Modal' }: ContactFormModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submissionData = {
        ...
        formType: `${formType} Modal Form`,
        source: `${source} - Mid CTA`
      };
        ...
        >
          ...
          >
            <img
              ...
              alt="D&D Design Center interior designer"
