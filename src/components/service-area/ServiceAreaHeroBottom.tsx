...
interface ServiceAreaHeroBottomProps {
  formType: string;
...
const trackFormSubmitConversion = (eventCategory: string) => {
  if (typeof window !== 'undefined' && (window as any).gtag) {
    ...
    (window as any).gtag('event', 'form_submit', {
      'event_category': `${eventCategory}_conversion`,
...
const ServiceAreaHeroBottom = ({ formType, backgroundImage }: ServiceAreaHeroBottomProps) => {
  ...
  return (
    <section className="w-full relative bg-cover bg-center py-16 lg:py-24" style={{ backgroundImage: `url(${backgroundImage})` }}>
      {/* White overlay */}
...
export default ServiceAreaHeroBottom;
