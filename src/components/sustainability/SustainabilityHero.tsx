  ...
  return (
    <section className="relative h-screen overflow-hidden perspective-1000">
      <div className="absolute inset-0 w-full h-full">
        <img
          ref={imageRef}
          src="https://res.cloudinary.com/designcenter/image/upload/How_we_make_sustainable_designs.avif"
          alt="Luxury furniture collection showcasing high-end Italian craftsmanship with sustainable initiatives"
