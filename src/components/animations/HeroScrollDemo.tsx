    ...
    <div ref={mainContainerRef} className="flex flex-col overflow-hidden bg-white">
      ...
      >
        <div className="w-full h-full flex flex-col">
          <video
            src="https://res.cloudinary.com/designcenter/video/upload/visionnaire-luxury-collection.mp4"
            autoPlay
            muted
            loop
            playsInline
      ...
      >
        {['Mastery', 'Quality', 'Elegance'].map((word, index) => (
          <span
            ...
            className="text-10xl md:text-[6rem] font-bold leading-[1.2] text-transparent bg-clip-text bg-gradient-to-r from-[#cca267] to-black transform-gpu relative pb-2" // Added leading and bottom padding
            style={{
