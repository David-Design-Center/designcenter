...
export interface Subcategory {
  ...
  image: string;
  parentId: number;
  backendTitle?: string; // New property to store the value used for fetching (e.g., "LIGHT")
}
...
export const mainCategories: Category[] = [
  {
    ...
    description: "Luxury kitchens designed for functionality, aesthetics, and efficiency.",
    ...
    subcategories: [
      ...
      },
      {
        ...
        image: "https://res.cloudinary.com/designcenter/image/upload/Product_2/Kitchen/Traditional/Kitchen_Traditional_8.avif",
        parentId: 1,
      },
      {
        id: 103,
        ...
        image: "https://res.cloudinary.com/designcenter/image/upload/Product_2/Kitchen/Art_Deco/Kitchen_Art_Deco_16.avif",
        parentId: 1,
      },
    ],
  },
  {
    ...
    description: "Experience the perfect blend of luxury and functionality with handcrafted bespoke furniture.",
  ...
  },
  {
    ...
    description: "Illuminate your interiors with premium lighting designs to create stunning atmospheres.",
    ...
    backendTitle: "LIGHT", // This is used for fetching or filtering in the background
  },
  {
    id: 4,
    title: "BATH",
    subtitle: "Inner Peace of Italy",
    description: "Transform your bathroom into a spa-like retreat with exquisite materials and luxurious finishes.",
  ...
  },
  {
    id: 7,
    title: "CLOSET",
    subtitle: "Stylish Storage",
    description: "Luxury closet designs that combine functionality and style to create a sophisticated storage solution.",
