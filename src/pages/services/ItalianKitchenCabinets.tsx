...
import KitchenGallery from '../../components/shared/KitchenGallery';
...
const ItalianKitchenCabinets = () => {
  ...
  return (
      ...
      >
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 relative z-10 text-white text-center md:text-left flex flex-col md:flex-row items-center">
          <div className="md:w-3/5 md:pr-12">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-light mb-8">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-w-9 aspect-h-12 rounded-lg overflow-hidden shadow-lg">
                  <img
                    src="https://res.cloudinary.com/designcenter/image/upload/v1778340740/WhatsApp_Image_2026-05-01_at_20.28.51_fdc09g.avif"
                    alt="Italian kitchen project showcase"
              ...
              <div className="lg:pl-8">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif mb-6 sm:mb-8 text-[#2C3E2D]">
                  Process of Designing Your Custom Italian Kitchen
                </h2>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif mb-4 sm:mb-6 text-[#2C3E2D]">
              Examples of Luxury Italian Kitchen Designs
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-10 mt-8 sm:mt-12" ref={showcaseImagesRef}>
            {[
              {
                src: "https://res.cloudinary.com/designcenter/image/upload/v1741899499/Luxury%20Kitchen%20Interiors%20%E2%80%93%20Custom%20Cabinetry%20and%20Marble%20Finishes.avif",
          ...
          <div className="mt-10 flex justify-center">
            <button 
              onClick={handleConsultation}
              className="bg-[#D6A85B] hover:bg-[#B48040] text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium transition-colors duration-300 flex items-center justify-center gap-2 min-w-[200px] sm:min-w-[250px] min-h-[48px] sm:min-h-[54px] shadow-lg"
            >
              Send Inquery
              <ArrowRight className="w-4 sm:w-5 h-4 sm:h-5" />
            </button>
    ...
    {/* Consultation CTA Section */}
      ...
      <section 
        ref={contentRef} 
        className="py-10 sm:py-12 lg:py-16 bg-white"
      >
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
          <div className="max-w-sm mx-auto">
            {/* Improved section heading with visual separator */}
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-serif mb-2 sm:mb-3 text-center text-[#2C3E2D]">
              Why Choose Italian Cabinets for New York Homes?
            </h2>
            <div className="w-12 sm:w-16 h-0.5 bg-[#D6A85B] mx-auto mb-6 sm:mb-8"></div>
            ...
            <div className="mx-auto mt-4 sm:mt-6">
              ...
              <h3 className="text-lg sm:text-xl font-serif mt-8 sm:mt-10 mb-3 sm:mb-4 text-gray-900">The Italian Craftsmanship Advantage</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
              ...
              <h3 className="text-lg sm:text-xl font-serif mt-8 sm:mt-10 mb-3 sm:mb-4 text-gray-900">Designed for New York Living</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
                ...
                {[
                  {
                    ...
                    a: "Typical projects take 12-16 weeks from design approval to installation, including shipping from Italy. At D&D Design Center, we confirm lead times up front and can offer rush options on select collections."
                  },
                  {
                    q: "Do Italian kitchen cabinet companies include installation?",
                    a: "Many do, but it varies by provider and product line. D&D Design Center includes professional installation and manages NYC building requirements for a clean, accurate fit."
                  },
                  {
                    q: "Can Italian kitchen cabinets be customized for finishes and hardware?",
                    a: "Yes, most premium Italian brands offer extensive customization. At D&D Design Center, you can select finishes, hardware, and internal accessories tailored to your layout and style."
                  },
                  {
                    q: "What is the typical price range for Italian kitchen cabinets in NYC?",
                    a: "Pricing often ranges from $30,000 to $100,000+ depending on size, materials, and customization. D&D Design Center provides detailed, line-item quotes after a design consultation."
                  },
                  {
                    q: "Should I involve an architect or contractor for a kitchen remodel?",
                    a: "It depends on scope and building requirements. D&D Design Center regularly coordinates with architects and contractors, or can guide you if you are starting without a team."
                  }
                ].map((faq, index) => (
