export const accordionFeatureSeoMetadata = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We first explore how you envision dining experiences in your home-whether formal, casual, or a seamless extension of your living area. Our team designs a tailored dining environment around your needs, recommending custom Italian tables, handcrafted seating, and lighting that sets the perfect ambiance. We oversee every element, from proportion and material selection to installation and styling, ensuring your dining room becomes a sophisticated space for memorable gatherings and daily enjoyment."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "We collaborate with you to understand the emotional tone and architectural needs of each space before designing a layered lighting plan. Our specialists source Italian-made chandeliers, sconces, and recessed lighting systems that blend artistry and functionality. We provide detailed lighting schematics and coordinate installation with our trusted electricians, ensuring your home radiates atmosphere, elegance, and warmth at every hour."
      }
    },
    {
      "@type": "Question",
